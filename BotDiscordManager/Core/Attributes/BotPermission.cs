    ...
    public class BotPermission : PreconditionAttribute
    {
        ...
        public override async Task<PreconditionResult> CheckRequirementsAsync(IInteractionContext context, ICommandInfo commandInfo, IServiceProvider services)
        {
            ...
            if (GuildPermission.HasValue)
            {
                ...
                {
                    return PreconditionResult.FromError(ErrorMessage ?? $"{Resources.NOT_PERMISSION_BOT} {Utils.BoldText(Utils.HighlightText(GuildPermission.Value.ToString()))}.");
                }
            }
            ...
            {
                return PreconditionResult.FromError(ErrorMessage ?? $"{Resources.BOT_NOT_PERMISSION_CHANNEL}  {Utils.BoldText(Utils.HighlightText(ChannelPermission.Value.ToString()))}.");
            }
